...
export default function WhyChooseUs({ destCount }: { destCount: number }) {
  const features = [
    ...
    { icon: FaShieldAlt, title: "Safe & Secure Booking", desc: "Your payments and personal data are protected with industry-leading security standards.", color: "text-teal-500 bg-teal-500/10" },
    { icon: FaHeadset, title: "24/7 Customer Support", desc: "Our dedicated team is always available to assist you before, during, and after your trip.", color: "text-sky-500 bg-sky-500/10" },
    { icon: FaGlobe, title: `${destCount > 0 ? `${destCount}+` : "Curated"} Destinations`, desc: "Explore our handpicked collection of destinations across Asia and beyond.", color: "text-teal-500 bg-teal-500/10" },
  ];

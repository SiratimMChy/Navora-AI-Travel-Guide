    ...
    <section className="py-16 px-4 bg-base-200">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-base-content mb-3">Popular Destinations</h2>
          <p className="text-base-content/60 text-base sm:text-lg">Handpicked places loved by thousands of travelers</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {destinations.map((dest) => (
            <div key={String(dest._id)} className="bg-base-100 rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div>
                    ...
                    <p className="flex items-center gap-1 text-sm font-semibold text-base-content">
                      ...
                      {dest.rating}
                      <span className="text-base-content/40 font-normal">({dest.reviewCount.toLocaleString()})</span>
                    </p>
                  </div>

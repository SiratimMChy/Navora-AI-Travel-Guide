...
const steps = [
  {
    ...
    desc: "Browse hundreds of destinations or let our AI recommend the perfect trip based on your preferences.",
  },
  {
    icon: FaMapMarkerAlt,
    step: "02",
    title: "Choose Your Journey",
    desc: "Pick from curated tours, set your dates, and customize your itinerary to match your travel style.",
  },
  {
    icon: FaSuitcaseRolling,
    step: "03",
    title: "Book with Confidence",
    desc: "Secure your booking instantly with transparent pricing and flexible cancellation options.",
  },
  {
    icon: FaSmile,
    step: "04",
    title: "Explore & Enjoy",
    desc: "Pack your bags and go. Our team is available around the clock to support you on your adventure.",
  },
];
    ...
    <section className="py-20 px-4 bg-base-200">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          <span className="inline-block bg-sky-100 text-sky-600 text-xs font-semibold px-4 py-1.5 rounded-full uppercase tracking-widest mb-4">
            Simple Process
          </span>
          ...
          <p className="text-base-content/60 text-base max-w-xl mx-auto">
            From dreaming to doing — your perfect trip in four easy steps.
          </p>
        </div>
